 ...
 * @version    CVS: $Id$
 * @link       http://pear.php.net/package/Text_Wiki2
 */

/**
 * The baseline abstract parser class.
 */
require_once 'Text/Wiki2/Parse.php';
...
class Text_Wiki2
{
    ...
    *
    * Even though Text_Wiki2 will render the tokens from parsed text,
    ...
    *
    * As Text_Wiki2 applies rule classes to the source text, it will
    ...
    * @var array
    */
    protected $_countRulesTokens = array();
    ...
    *
    * Text_Wiki2 creates one instance of every rule that is applied to
    ...
    *
    */
    protected $_dirSep = DIRECTORY_SEPARATOR;
     ...
     * @var string
     */
    protected $renderingType = 'normal';
    ...
    * Singleton.
    *
    * This avoids instantiating multiple Text_Wiki2 instances where a number
    ...
    */
    ...
    /**
     * Returns a Text_Wiki2 Parser class for the specified parser.
     *
     * @access public
     * @static
...
//Damn strtok()! Why does it "skip" empty parts of the string. It's useless now!
    ...
    */
    ...
    /**
    *
    * Add a token to the Text_Wiki2 tokens array, and return a delimited
    * token number.
    *
    * @access public
    *
    ...
    */
    public function addToken($rule, $options = array(), $id_only = false)
    {
        ...
        // multiple times with the same Text_Wiki2 object, the ID number
