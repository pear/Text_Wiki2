...
require_once 'Text/Wiki2/Render/Tiki.php';
require_once 'Text/Wiki2/Render/Tiki/Anchor.php';
require_once 'Text/Wiki2/Render/Tiki/Blockquote.php';
require_once 'Text/Wiki2/Render/Tiki/Bold.php';
require_once 'Text/Wiki2/Render/Tiki/Box.php';
require_once 'Text/Wiki2/Render/Tiki/Break.php';
require_once 'Text/Wiki2/Render/Tiki/Center.php';
require_once 'Text/Wiki2/Render/Tiki/Code.php';
require_once 'Text/Wiki2/Render/Tiki/Colortext.php';
require_once 'Text/Wiki2/Render/Tiki/Deflist.php';
require_once 'Text/Wiki2/Render/Tiki/Delimiter.php';
require_once 'Text/Wiki2/Render/Tiki/Embed.php';
require_once 'Text/Wiki2/Render/Tiki/Emphasis.php';
require_once 'Text/Wiki2/Render/Tiki/Freelink.php';
require_once 'Text/Wiki2/Render/Tiki/Function.php';
require_once 'Text/Wiki2/Render/Tiki/Heading.php';
require_once 'Text/Wiki2/Render/Tiki/Horiz.php';
require_once 'Text/Wiki2/Render/Tiki/Html.php';
require_once 'Text/Wiki2/Render/Tiki/Image.php';
require_once 'Text/Wiki2/Render/Tiki/Include.php';
require_once 'Text/Wiki2/Render/Tiki/Interwiki.php';
require_once 'Text/Wiki2/Render/Tiki/Italic.php';
require_once 'Text/Wiki2/Render/Tiki/List.php';
require_once 'Text/Wiki2/Render/Tiki/Newline.php';
require_once 'Text/Wiki2/Render/Tiki/Paragraph.php';
require_once 'Text/Wiki2/Render/Tiki/Phplookup.php';
require_once 'Text/Wiki2/Render/Tiki/Prefilter.php';
require_once 'Text/Wiki2/Render/Tiki/Preformatted.php';
require_once 'Text/Wiki2/Render/Tiki/Raw.php';
require_once 'Text/Wiki2/Render/Tiki/Redirect.php';
require_once 'Text/Wiki2/Render/Tiki/Revise.php';
require_once 'Text/Wiki2/Render/Tiki/Strong.php';
require_once 'Text/Wiki2/Render/Tiki/Subscript.php';
require_once 'Text/Wiki2/Render/Tiki/Superscript.php';
require_once 'Text/Wiki2/Render/Tiki/Table.php';
require_once 'Text/Wiki2/Render/Tiki/Tighten.php';
require_once 'Text/Wiki2/Render/Tiki/Toc.php';
require_once 'Text/Wiki2/Render/Tiki/Tt.php';
require_once 'Text/Wiki2/Render/Tiki/Underline.php';
require_once 'Text/Wiki2/Render/Tiki/Url.php';
require_once 'Text/Wiki2/Render/Tiki/Wikilink.php';
